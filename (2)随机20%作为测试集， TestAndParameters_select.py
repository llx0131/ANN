...
class MyDataset(Dataset):
    ...
    def __init__(self, col=1):
        ...
        data2 = np.loadtxt('/home/hongchang/Documents/pytorch计算/WWTPs温度扰动课题/Microbiom-ASV-alpha_select.csv',delimiter=',',skiprows=1,usecols=col, dtype=np.float32)
...
np.savetxt('/home/hongchang/Documents/pytorch计算/WWTPs温度扰动课题/results/alpha/analysis新45/' + 'Test_log-10_select-sigmoid.txt',Test_result, fmt='%.4e', delimiter='\t', newline='\n')
np.savetxt('/home/hongchang/Documents/pytorch计算/WWTPs温度扰动课题/results/alpha/analysis新45/' + 'Test_and_parameters-10_select-sigmoid.csv',para, fmt='%.4e', delimiter=',', newline='\n')
